...
load_dotenv()
st.set_page_config(
    page_title="Admission CHATBOT made by Garvit, Divyam,Vanshika ",
    page_icon="🤖",
    layout="wide",
...
file_path = r"C:\Users\dell\Documents\ADMISSION-CHATBOT\dtc.txt"
...
def main():
    st.header("Admission Chatbot made by Garvit Divyam and Vanshika ")
    st.write("Hello, welcome! Feel free to ask me anything about NCR top college.")

    question = st.text_input("Ask a question:")

    if st.button("Ask Questions"):
        with st.spinner("Please wait for a moment while i am searching the available information :)"):
            raw_text = text_file_to_text(file_path )
            if raw_text is None:
                return
